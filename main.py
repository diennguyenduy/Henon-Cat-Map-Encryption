...
class MainApplication:
    def __init__(self, app, key):
        ...
        self.app.title("Image "+self.encrypt_text.get()+"ion - DIEN NGUYEN DUY")
...
class LoginApp:
    def __init__(self, app):
        self.app = app
        self.app.geometry('%sx%s' % (int(self.app.winfo_screenwidth()/4), int(app.winfo_screenheight()/2)))
        self.app.resizable(width=False, height=False)
        self.app.title("Login - DIEN NGUYEN DUY")
